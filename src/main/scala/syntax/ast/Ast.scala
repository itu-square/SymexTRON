...
case class Match(e : SetExpr, s : Sort) extends MatchExpr
case class MatchStar(e : SetExpr, s : Sort) extends MatchExpr
...
case class For(x : Vars, s : Sort, e : MatchExpr, inv: (Symbols, Set[SymbolicMemory]), cb: Command)
  extends Command
